...
!(function(e, t) {
    ...
    return (function(e) {
        ...
        return (
            ...
            (t.p = "D:\\code\\cos-wx-sdk-v5\\demo\\lib"),
            t((t.s = 6))
        );
    })([
        function(e, t, n) {
                ...
                var m = n(8),
                    ...
                    C = function(e) {
                        ...
                        return [
                            ...
                            "q-header-list=" + C,
                            "q-url-param-list=" + k,
                            "q-signature=" + f.HmacSHA1(R, b).toString()
                        ].join("&");
                    },
                    k = function() {},
                    b = function(e) {
                        ...
                        "postObject" === e
                            ...
                            ? y.stat({
                                  ...
                                  success: function(e) {
                                      var i = e.stats;
                                      (t.FileStat = i),
                                          (t.FileStat.FilePath = t.FilePath);
                                      var a = i.isDirectory() ? 0 : i.size;
                                      (t.ContentLength = a = a || 0),
                                          n(null, a);
                                  },
                                  fail: function(e) {
                                      n(e);
        ...
        function(e, t) {
            ...
            function U(e, t, n, i, a) {
                ...
                switch (e.nodeType) {
                    case G:
                        ...
                        if (
                            s ||
                            (n && !/^(?:meta|link|img|br|hr|input)$/i.test(c))
                        ) {
                            if ((t.push(">"), n && /^script$/i.test(c)))
                                for (; s; )
                                    s.data ? t.push(s.data) : U(s, t, n, i, a),
                                        (s = s.nextSibling);
                            else
                                for (; s; )
                                    U(s, t, n, i, a), (s = s.nextSibling);
                            t.push("</", c, ">");
                        } else t.push("/>");
            ...
            function F(e, t, n) {
                ...
                if (
                    ...
                    for (var a = t.firstChild; a; )
                        i.appendChild(F(e, a, n)), (a = a.nextSibling);
                return i;
            }
            ...
            function H(e, t, n) {
                ...
                switch (
                    (t.childNodes && (i.childNodes = new o()),
                    (i.ownerDocument = e),
                    i.nodeType)
                ) {
                    case G:
                        ...
                        for (var u = 0; u < p; u++)
                            i.setAttributeNode(H(e, s.item(u), !0));
                ...
                if (n)
                    for (var d = t.firstChild; d; )
                        i.appendChild(H(e, d, n)), (d = d.nextSibling);
                return i;
            }
            ...
            var K = "http://www.w3.org/1999/xhtml",
                ...
                ae = {},
                oe =
                    ((ie.INDEX_SIZE_ERR = ((ae[1] = "Index size error"), 1)),
                    (ie.DOMSTRING_SIZE_ERR =
                        ((ae[2] = "DOMString size error"), 2)),
                    (ie.HIERARCHY_REQUEST_ERR =
                        ((ae[3] = "Hierarchy request error"), 3))),
                re =
                    ((ie.WRONG_DOCUMENT_ERR = ((ae[4] = "Wrong document"), 4)),
                    (ie.INVALID_CHARACTER_ERR =
                        ((ae[5] = "Invalid character"), 5)),
                    (ie.NO_DATA_ALLOWED_ERR = ((ae[6] = "No data allowed"), 6)),
                    (ie.NO_MODIFICATION_ALLOWED_ERR =
                        ((ae[7] = "No modification allowed"), 7)),
                    (ie.NOT_FOUND_ERR = ((ae[8] = "Not found"), 8))),
                se =
                    ((ie.NOT_SUPPORTED_ERR = ((ae[9] = "Not supported"), 9)),
                    (ie.INUSE_ATTRIBUTE_ERR =
                        ((ae[10] = "Attribute in use"), 10)));
            (ie.INVALID_STATE_ERR = ((ae[11] = "Invalid state"), 11)),
                (ie.SYNTAX_ERR = ((ae[12] = "Syntax error"), 12)),
                (ie.INVALID_MODIFICATION_ERR =
                    ((ae[13] = "Invalid modification"), 13)),
                (ie.NAMESPACE_ERR = ((ae[14] = "Invalid namespace"), 14)),
                (ie.INVALID_ACCESS_ERR = ((ae[15] = "Invalid access"), 15));
            (a.prototype = Error.prototype),
                ...
                (c.prototype = {
                    ...
                    setNamedItemNS: function(e) {
                        ...
                        return (
                            (t = this.getNamedItemNS(
                                e.namespaceURI,
                                e.localName
                            )),
                            p(this._ownerElement, this, e, t),
                            t
                        );
                    },
                ...
                (g.prototype = {
                    ...
                    getElementById: function(e) {
                        var t = null;
                        return (
                            h(this.documentElement, function(n) {
                                if (
                                    n.nodeType == G &&
                                    n.getAttribute("id") == e
                                )
                ...
                (g.prototype.getElementsByTagName =
                    S.prototype.getElementsByTagName),
                (g.prototype.getElementsByTagNameNS =
                    S.prototype.getElementsByTagNameNS),
                i(S, m),
                ...
                i(E, m),
                (B.prototype.nodeType = ne),
                i(B, m),
                (O.prototype.nodeType = Q),
                i(O, m),
                (D.prototype.nodeType = $),
                i(D, m),
                (N.prototype.nodeName = "#document-fragment"),
                (N.prototype.nodeType = te),
                i(N, m),
                (I.prototype.nodeType = J),
                i(I, m),
        ...
        function(e, t, n) {
            var i,
                ...
                r = function() {
                    try {
                        var e = JSON.parse(
                            _my.getStorageSync("cos_sdk_upload_cache")
                        );
                    } catch (e) {}
                        ...
                        (Md5.prototype.hash = function() {
                            ...
                            this.first
                                ? ((e = r[0] - 680876937),
                                  ...
                                  (i = (((i << 12) | (i >>> 20)) + e) << 0),
                                  (n =
                                      (-271733879 ^ (i & (-271733879 ^ e))) +
                                      r[2] -
                                      1126478375),
                                  (n = (((n << 17) | (n >>> 15)) + i) << 0),
                                  (t = (e ^ (n & (i ^ e))) + r[3] - 1316259209),
                                  (t = (((t << 22) | (t >>> 10)) + n) << 0))
                                : ((e = this.h0),
                                  (t = this.h1),
                                  (n = this.h2),
                                  (i = this.h3),
                                  (e += (i ^ (t & (n ^ i))) + r[0] - 680876936),
                                  (e = (((e << 7) | (e >>> 25)) + t) << 0),
                                  (i += (n ^ (e & (t ^ n))) + r[1] - 389564586),
                                  (i = (((i << 12) | (i >>> 20)) + e) << 0),
                                  (n += (t ^ (i & (e ^ t))) + r[2] + 606105819),
                                  (n = (((n << 17) | (n >>> 15)) + i) << 0),
                                  (t +=
                                      (e ^ (n & (i ^ e))) + r[3] - 1044525330),
                                  (t = (((t << 22) | (t >>> 10)) + n) << 0)),
                                (e += (i ^ (t & (n ^ i))) + r[4] - 176418897),
                                (e = (((e << 7) | (e >>> 25)) + t) << 0),
                                (i += (n ^ (e & (t ^ n))) + r[5] + 1200080426),
                                (i = (((i << 12) | (i >>> 20)) + e) << 0),
                                (n += (t ^ (i & (e ^ t))) + r[6] - 1473231341),
                                (n = (((n << 17) | (n >>> 15)) + i) << 0),
                                (t += (e ^ (n & (i ^ e))) + r[7] - 45705983),
                                (t = (((t << 22) | (t >>> 10)) + n) << 0),
                                (e += (i ^ (t & (n ^ i))) + r[8] + 1770035416),
                                (e = (((e << 7) | (e >>> 25)) + t) << 0),
                                (i += (n ^ (e & (t ^ n))) + r[9] - 1958414417),
                                (i = (((i << 12) | (i >>> 20)) + e) << 0),
                                (n += (t ^ (i & (e ^ t))) + r[10] - 42063),
                                (n = (((n << 17) | (n >>> 15)) + i) << 0),
                                (t += (e ^ (n & (i ^ e))) + r[11] - 1990404162),
                                (t = (((t << 22) | (t >>> 10)) + n) << 0),
                                (e += (i ^ (t & (n ^ i))) + r[12] + 1804603682),
                                (e = (((e << 7) | (e >>> 25)) + t) << 0),
                                (i += (n ^ (e & (t ^ n))) + r[13] - 40341101),
                                (i = (((i << 12) | (i >>> 20)) + e) << 0),
                                (n += (t ^ (i & (e ^ t))) + r[14] - 1502002290),
                                (n = (((n << 17) | (n >>> 15)) + i) << 0),
                                (t += (e ^ (n & (i ^ e))) + r[15] + 1236535329),
                                (t = (((t << 22) | (t >>> 10)) + n) << 0),
                                (e += (n ^ (i & (t ^ n))) + r[1] - 165796510),
                                (e = (((e << 5) | (e >>> 27)) + t) << 0),
                                (i += (t ^ (n & (e ^ t))) + r[6] - 1069501632),
                                (i = (((i << 9) | (i >>> 23)) + e) << 0),
                                (n += (e ^ (t & (i ^ e))) + r[11] + 643717713),
                                (n = (((n << 14) | (n >>> 18)) + i) << 0),
                                (t += (i ^ (e & (n ^ i))) + r[0] - 373897302),
                                (t = (((t << 20) | (t >>> 12)) + n) << 0),
                                (e += (n ^ (i & (t ^ n))) + r[5] - 701558691),
                                (e = (((e << 5) | (e >>> 27)) + t) << 0),
                                (i += (t ^ (n & (e ^ t))) + r[10] + 38016083),
                                (i = (((i << 9) | (i >>> 23)) + e) << 0),
                                (n += (e ^ (t & (i ^ e))) + r[15] - 660478335),
                                (n = (((n << 14) | (n >>> 18)) + i) << 0),
                                (t += (i ^ (e & (n ^ i))) + r[4] - 405537848),
                                (t = (((t << 20) | (t >>> 12)) + n) << 0),
                                (e += (n ^ (i & (t ^ n))) + r[9] + 568446438),
                                (e = (((e << 5) | (e >>> 27)) + t) << 0),
                                (i += (t ^ (n & (e ^ t))) + r[14] - 1019803690),
                                (i = (((i << 9) | (i >>> 23)) + e) << 0),
                                (n += (e ^ (t & (i ^ e))) + r[3] - 187363961),
                                (n = (((n << 14) | (n >>> 18)) + i) << 0),
                                (t += (i ^ (e & (n ^ i))) + r[8] + 1163531501),
                                (t = (((t << 20) | (t >>> 12)) + n) << 0),
                                (e += (n ^ (i & (t ^ n))) + r[13] - 1444681467),
                                (e = (((e << 5) | (e >>> 27)) + t) << 0),
                                (i += (t ^ (n & (e ^ t))) + r[2] - 51403784),
                                (i = (((i << 9) | (i >>> 23)) + e) << 0),
                                (n += (e ^ (t & (i ^ e))) + r[7] + 1735328473),
                                (n = (((n << 14) | (n >>> 18)) + i) << 0),
                                (t += (i ^ (e & (n ^ i))) + r[12] - 1926607734),
                                (t = (((t << 20) | (t >>> 12)) + n) << 0),
                                (a = t ^ n),
                                (e += (a ^ i) + r[5] - 378558),
                                (e = (((e << 4) | (e >>> 28)) + t) << 0),
                                (i += (a ^ e) + r[8] - 2022574463),
                                (i = (((i << 11) | (i >>> 21)) + e) << 0),
                                (o = i ^ e),
                                (n += (o ^ t) + r[11] + 1839030562),
                                (n = (((n << 16) | (n >>> 16)) + i) << 0),
                                (t += (o ^ n) + r[14] - 35309556),
                                (t = (((t << 23) | (t >>> 9)) + n) << 0),
                                (a = t ^ n),
                                (e += (a ^ i) + r[1] - 1530992060),
                                (e = (((e << 4) | (e >>> 28)) + t) << 0),
                                (i += (a ^ e) + r[4] + 1272893353),
                                (i = (((i << 11) | (i >>> 21)) + e) << 0),
                                (o = i ^ e),
                                (n += (o ^ t) + r[7] - 155497632),
                                (n = (((n << 16) | (n >>> 16)) + i) << 0),
                                (t += (o ^ n) + r[10] - 1094730640),
                                (t = (((t << 23) | (t >>> 9)) + n) << 0),
                                (a = t ^ n),
                                (e += (a ^ i) + r[13] + 681279174),
                                (e = (((e << 4) | (e >>> 28)) + t) << 0),
                                (i += (a ^ e) + r[0] - 358537222),
                                (i = (((i << 11) | (i >>> 21)) + e) << 0),
                                (o = i ^ e),
                                ...
                                (e += (a ^ i) + r[9] - 640364487),
                                (e = (((e << 4) | (e >>> 28)) + t) << 0),
                                (i += (a ^ e) + r[12] - 421815835),
                                (i = (((i << 11) | (i >>> 21)) + e) << 0),
                                (o = i ^ e),
                                (n += (o ^ t) + r[15] + 530742520),
                                (n = (((n << 16) | (n >>> 16)) + i) << 0),
                                (t += (o ^ n) + r[2] - 995338651),
                                (t = (((t << 23) | (t >>> 9)) + n) << 0),
                                (e += (n ^ (t | ~i)) + r[0] - 198630844),
                                (e = (((e << 6) | (e >>> 26)) + t) << 0),
                                (i += (t ^ (e | ~n)) + r[7] + 1126891415),
                                (i = (((i << 10) | (i >>> 22)) + e) << 0),
                                (n += (e ^ (i | ~t)) + r[14] - 1416354905),
                                (n = (((n << 15) | (n >>> 17)) + i) << 0),
                                (t += (i ^ (n | ~e)) + r[5] - 57434055),
                                (t = (((t << 21) | (t >>> 11)) + n) << 0),
                                (e += (n ^ (t | ~i)) + r[12] + 1700485571),
                                (e = (((e << 6) | (e >>> 26)) + t) << 0),
                                (i += (t ^ (e | ~n)) + r[3] - 1894986606),
                                (i = (((i << 10) | (i >>> 22)) + e) << 0),
                                (n += (e ^ (i | ~t)) + r[10] - 1051523),
                                (n = (((n << 15) | (n >>> 17)) + i) << 0),
                                (t += (i ^ (n | ~e)) + r[1] - 2054922799),
                                (t = (((t << 21) | (t >>> 11)) + n) << 0),
                                (e += (n ^ (t | ~i)) + r[8] + 1873313359),
                                (e = (((e << 6) | (e >>> 26)) + t) << 0),
                                (i += (t ^ (e | ~n)) + r[15] - 30611744),
                                (i = (((i << 10) | (i >>> 22)) + e) << 0),
                                (n += (e ^ (i | ~t)) + r[6] - 1560198380),
                                (n = (((n << 15) | (n >>> 17)) + i) << 0),
                                (t += (i ^ (n | ~e)) + r[13] + 1309151649),
                                (t = (((t << 21) | (t >>> 11)) + n) << 0),
                                (e += (n ^ (t | ~i)) + r[4] - 145523070),
                                (e = (((e << 6) | (e >>> 26)) + t) << 0),
                                (i += (t ^ (e | ~n)) + r[11] - 1120210379),
                                (i = (((i << 10) | (i >>> 22)) + e) << 0),
                                (n += (e ^ (i | ~t)) + r[2] + 718787259),
                                (n = (((n << 15) | (n >>> 17)) + i) << 0),
                                (t += (i ^ (n | ~e)) + r[9] - 343485551),
                                (t = (((t << 21) | (t >>> 11)) + n) << 0),
                                this.first
        ...
        function(e, t) {
            ...
            !(function() {
                ...
                (e.SHA1 = a._createHelper(t)),
                    (e.HmacSHA1 = a._createHmacHelper(t));
            })(),
                (function() {
                    var e = n,
                        t = e.enc.Utf8;
                ...
                (function() {
                    ...
                    a.Base64 = {
                        ...
                        parse: function(e) {
                            ...
                            for (var r = [], s = 0, c = 0; c < t; c++)
                                if (c % 4) {
                                    var l =
                                            n.indexOf(e.charAt(c - 1)) <<
                                            ((c % 4) * 2),
                                        p =
                                            n.indexOf(e.charAt(c)) >>>
                                            (6 - (c % 4) * 2);
                                    (r[s >>> 2] |=
                                        (l | p) << (24 - (s % 4) * 8)),
                                        s++;
                ...
                a = function(e) {
                    ...
                    function o(e, t, n, i) {
                        for (var a = 0; a < e.length; a++) {
                            ...
                            if ("string" == typeof o) {
                                ...
                                if (o.test(i)) break;
                            } else if ("function" == typeof o && o(t, n, i))
                                break;
                        }
                    ...
                    function r(t, n, i) {
                        ...
                        !(t[n] instanceof Array) &&
                            ...
                            o(e.arrayAccessFormPaths, t, n, i) &&
                            (t[n] = [t[n]]);
                    }
                    ...
                    function c(t, n, i) {
                        if (e.datetimeAccessFormPaths.length > 0) {
                            var a = i.split(".#")[0];
                            return o(e.datetimeAccessFormPaths, t, n, a)
                                ? s(t)
                                : t;
                        }
                    ...
                    function l(t, n, i, a) {
                        return (
                            !(
                                n == S.ELEMENT_NODE &&
                                e.xmlElementsFilter.length > 0
                            ) || o(e.xmlElementsFilter, t, i, a)
                        );
                    }
                    ...
                    function p(i, a) {
                        if (i.nodeType == S.DOCUMENT_NODE) {
                            for (
                                var o = new Object(), s = i.childNodes, u = 0;
                                u < s.length;
                                u++
                            ) {
                                var d = s.item(u);
                        ...
                        if (i.nodeType == S.ELEMENT_NODE) {
                            ...
                            for (var h = 0; h < i.attributes.length; h++) {
                                ...
                                o.__cnt++,
                                    (o[e.attributePrefix + g.name] = g.value);
                            }
                        ...
                        if (
                            ...
                            i.nodeType == S.CDATA_SECTION_NODE
                        )
                            return i.nodeValue;
                    }
                        ...
                        if (null != i)
                            for (var s = 0; s < i.length; s++) {
                                ...
                                e.escapeMode && (l = a(l)),
                                    (r +=
                                        " " +
                                        c.substr(e.attributePrefix.length) +
                                        "="),
                                    e.useDoubleQuotes
                                        ? (r += '"' + l + '"')
                                        : (r += "'" + l + "'");
                    ...
                    function g(t, n, i) {
                        return (
                            ...
                            "" == i ||
                            o(e.jsonPropertiesFilter, t, n, i)
                        );
                    }
        ...
        function(e, t, n) {
            ...
            function a(e, t, n) {
                ...
                return (
                    (n = n || {}), i("warning"), i("error"), i("fatalError"), a
                );
            }
                ...
                (o.prototype = {
                    ...
                    startElement: function(e, t, n, i) {
                        ...
                        for (var c = 0; c < s; c++) {
                            ...
                            this.locator && r(i.getLocator(c), u),
            ...
            function i(e, t, n, i, l) {
                ...
                function f(e) {
                    ...
                    return t in n
                        ? n[t]
                        : "#" === t.charAt(0)
                        ? m(parseInt(t.substr(1).replace("x", "0x")))
                        : (l.error("entity not found:" + e), e);
                }
                ...
                function g(t, n) {
                    for (; t >= x && (n = y.exec(e)); )
                        (v = n.index), (x = v + n[0].length), C.lineNumber++;
                        ...
                        switch ((R > S && h(R), e.charAt(R + 1))) {
                            case "/":
                                ...
                                if (
                                    ...
                                    if (
                                        (i.endElement(E.uri, E.localName, T), B)
                                    )
                                        for (var D in B) i.endPrefixMapping(D);
                                    O ||
                                        l.fatalError(
                                            "end tag name: " +
                                                T +
                            ...
                            default:
                                ...
                                "http://www.w3.org/1999/xhtml" !== N.uri ||
                                N.closed
                                    ? A++
                                    : (A = s(e, A, N.tagName, f, i));
                        }
                    } catch (e) {
            ...
            function r(e, t, n) {
                for (var i = e.tagName, a = null, o = e.length; o--; ) {
                    var r = e[o],
                        ...
                        p = s.indexOf(":");
                    if (p > 0)
                        var u = (r.prefix = s.slice(0, p)),
                            d = s.slice(p + 1),
                            m = "xmlns" === u && d;
                    else (d = s), (u = null), (m = "xmlns" === s && "");
                    (r.localName = d),
                        !1 !== m &&
                            (null == a && ((a = {}), l(n, (n = {}))),
                            (n[m] = a[m] = c),
                            (r.uri = "http://www.w3.org/2000/xmlns/"),
                            t.startPrefixMapping(m, c));
                }
                ...
                var p = i.indexOf(":");
                p > 0
                    ? ((u = e.prefix = i.slice(0, p)),
                      (d = e.localName = i.slice(p + 1)))
                    : ((u = null), (d = e.localName = i));
                var f = (e.uri = n[u || ""]);
                if ((t.startElement(f, d, i, e), !e.closed))
                    return (e.currentNSMap = n), (e.localNSMap = a), !0;
                if ((t.endElement(f, d, i), a))
                    for (u in a) t.endPrefixMapping(u);
            }
                            ...
                            if (!(r >= e.options.FileParallelLimit)) {
                                ...
                                if (!(s >= t.length)) {
                                    ...
                                    s++,
                                        r++,
                                        (n.state = "checking"),
                                        n.params.onTaskStart &&
                                            n.params.onTaskStart(c(n)),
                                        !n.params.UploadData &&
                                            (n.params.UploadData = {});
                                ...
                                if (
                                    ...
                                    try {
                                        var d =
                                            o &&
                                            o.params &&
                                            o.params.UploadData.UploadId;
                                    } catch (e) {}

                                    "canceled" === a && d && i.removeUsing(d),
                                        l(),
                                        c && (r--, u()),
                                        "canceled" === a &&
                                            (o.params &&
        ...
        function(e, t, n) {
            ...
            function c(e, t) {
                ...
                if (e.AccessControlPolicy) {
                    ...
                    (o = _e.isArray(o) ? o : [o]),
                        ...
                        (n["Content-MD5"] = _e.binaryBase64(_e.md5(i)));
                }
            ...
            function p(e, t) {
                ...
                (o["Content-Type"] = "application/xml"),
                    (o["Content-MD5"] = _e.binaryBase64(_e.md5(a))),
                    be.call(
                        this,
                        {
            ...
            function f(e, t) {
                ...
                (a["Content-Type"] = "application/json"),
                    (a["Content-MD5"] = _e.binaryBase64(_e.md5(i))),
                    be.call(
                        this,
                        {
            ...
            function O(e, t) {
                ...
                (r["Content-Type"] = "application/xml"),
                    (r["Content-MD5"] = _e.binaryBase64(_e.md5(o))),
                    be.call(
                        this,
                        {
            ...
            function F(e, t) {
                ...
                (i["Content-Type"] = "application/xml"),
                    (i["Content-MD5"] = _e.binaryBase64(_e.md5(n))),
                    be.call(
                        this,
                        {
                ...
                be.call(
                    ...
                    function(e, n) {
                        ...
                        (a = _e.isArray(a) ? a : [a]),
                            ...
                            _e.each(a, function(e) {
                                if (
                                    e &&
                                    e.OptionalFields &&
                                    e.OptionalFields.Field
                                ) {
            ...
            function Q(e, t) {
                ...
                o["Cache-Control"] ||
                    ...
                    o["Content-Type"] ||
                        o["content-type"] ||
                        (o["Content-Type"] =
                            Ae.getType(e.Key) || "application/octet-stream"),
                    _e.getBodyMd5(
                        n.options.UploadCheckContentMd5,
                        e.Body,
                        function(r) {
                            r && (o["Content-MD5"] = _e.binaryBase64(r)),
            ...
            function J(e, t) {
                ...
                var r = _e.throttleOnProgress.call(
                    n,
                    i["Content-Length"],
                    e.onProgress
                );
            ...
            function oe(e, t) {
                ...
                (n["Content-Type"] = "application/xml"),
                    (n["Content-MD5"] = _e.binaryBase64(_e.md5(a))),
                    be.call(
                        this,
                        {
            ...
            function pe(e, t) {
                ...
                _e.getFileSize("multipartUpload", e, function() {
                    _e.getBodyMd5(
                        ...
                        function(i) {
                            i &&
                                (e.Headers["Content-MD5"] = _e.binaryBase64(i)),
                                be.call(
                                    n,
                                    {
            ...
            function ue(e, t) {
                ...
                (c["Content-Type"] = "application/xml"),
                    (c["Content-MD5"] = _e.binaryBase64(_e.md5(s))),
                    be.call(
                        this,
                        {
                    ...
                    be.call(
                        ...
                        function(e, n) {
                            ...
                            if (n && n.ListMultipartUploadsResult) {
                                var i =
                                        n.ListMultipartUploadsResult.Upload ||
                                        [],
                                    a =
                        ...
                        if (t) {
                            ...
                            (a +=
                                ...
                                (n.Authorization.indexOf("q-signature") > -1
                                    ? n.Authorization
                                    : "sign=" +
                                      encodeURIComponent(n.Authorization))),
                                n.XCosSecurityToken &&
                                    (a +=
                                        "&x-cos-security-token=" +
                                        n.XCosSecurityToken),
                                n.ClientIP && (a += "&clientIP=" + n.ClientIP),
                                n.ClientUA && (a += "&clientUA=" + n.ClientUA),
                                n.Token && (a += "&token=" + n.Token),
                                setTimeout(function() {
                                    t(null, {
                                        Url: a
                                    });
            ...
            function xe(e) {
                ...
                for (t = 0; t < i.length; )
                    (n = i[t].trim()),
                        a[n] ? i.splice(t, 1) : ((a[n] = !0), (i[t] = n), t++);
            ...
            function ye(e) {
                ...
                return (
                    ...
                    (s += "/"),
                    r && (s += _e.camSafeUrlEncode(r).replace(/%2F/g, "/")),
            ...
            function Ce(e, t) {
                ...
                var i = function(e) {
                    ...
                    r = e.Region || "",
                    s =
                        "name/cos:PostObject" !== e.Action && e.Key
                            ? e.Key
                            : "";
                    ...
                    (function() {
                        ...
                        for (e = a._StsCache.length - 1; e >= 0; e--) {
                            ...
                            var n =
                                Math.round(
                                    _e.getSkewTime(
                                        a.options.SystemClockOffset
                                    ) / 1e3
                                ) + 30;
                            if (
                                (t.StartTime && n < t.StartTime) ||
                                n >= t.ExpiredTime
                            )
                                a._StsCache.splice(e, 1);
                            else if (
                                !t.ScopeLimit ||
                                (t.ScopeLimit && t.ScopeKey === m)
                            ) {
                                l = t;
                                break;
                            }
                ...
                if (
                    l.ExpiredTime &&
                    l.ExpiredTime -
                        _e.getSkewTime(a.options.SystemClockOffset) / 1e3 >
                        60
                )
                    f();
                    ...
                    if (!a.options.getSTS)
                        return (function() {
                            var t = _e.getAuth({
                                    ...
                                    SecretKey:
                                        e.SecretKey || a.options.SecretKey,
                                    Method: e.Method,
                                    Pathname: c,
                                    Query: e.Query,
                                    Headers: n,
                ...
                if (e)
                    if (n && i) {
                        ...
                        this.options.CorrectClockSkew &&
                            Math.abs(
                                _e.getSkewTime(this.options.SystemClockOffset) -
                                    r
                            ) >= 3e4 &&
                            (console.error("error: Local time is too skewed."),
                            (this.options.SystemClockOffset = r - Date.now()),
                            (t = !0));
            ...
            function be(e, t) {
                ...
                !e.headers && (e.headers = {}),
                    ...
                    (e.qs = _e.clearKey(e.qs)),
                    e.headers && (e.headers = _e.clearKey(e.headers)),
                    e.qs && (e.qs = _e.clearKey(e.qs));
                ...
                var a = function(o) {
                    ...
                    Ce.call(
                        ...
                        function(i, s) {
                            ...
                            (e.AuthData = s),
                                Se.call(n, e, function(i, s) {
                                    i &&
                                    o < 2 &&
                                    (r !== n.options.SystemClockOffset ||
                                        ke.call(n, i))
                                        ? (e.headers &&
            ...
            function Se(e, t) {
                ...
                if (!i || n._isRunningTask(i)) {
                    ...
                    (d.headers.Authorization = e.AuthData.Authorization),
                        e.AuthData.Token &&
                            (d.headers.token = e.AuthData.Token),
                        e.AuthData.ClientIP &&
                        ...
                        e.AuthData.XCosSecurityToken &&
                            (d.headers["x-cos-security-token"] =
                                e.AuthData.XCosSecurityToken),
                        d.headers && (d.headers = _e.clearKey(d.headers)),
                        (d = _e.clearKey(d)),
                        e.onProgress &&
            ...
            e.exports.init = function(e, t) {
                t.transferToTaskMethod(Te, "postObject"),
                    t.transferToTaskMethod(Te, "putObject"),
                    _e.each(Te, function(t, n) {
            ...
            var n = function(e) {
                ...
                i = function(e, t) {
                    ...
                    if (a) {
                        ...
                        e.pathStyle
                            ? ((p = decodeURIComponent(u[3] || "")),
                              (r = u[1] + u[2]))
                            : ((p = decodeURIComponent(u[2] + u[3] || "")),
                              (r = u[1]));
                        var d = {
                                key: p,
            ...
            (i.prototype.define = function(e, t) {
                ...
                (i.prototype.getType = function(e) {
                    ...
                    var t = e.replace(/^.*[\/\\]/, "").toLowerCase(),
                        ...
                        i = t.length < e.length;
                    return (
                        ((n.length < t.length - 1 || !i) && this._types[n]) ||
                        null
                    );
                }),
        ...
        function(e, t, n) {
            function i(e, t) {
                ...
                r.on("error", function(e) {
                        ...
                        l.call(
                            ...
                            function(t, a) {
                                if (n._isRunningTask(c)) {
                                    if ((h.removeUsing(e.UploadId), t))
                                        return o(null, !0), r.emit("error", t);
                                    h.removeUploadId(e.UploadId),
                                        o(
                                            {
                                                loaded: i,
                                                total: i
                    ...
                    r.on("get_upload_data_finish", function(t) {
                        ...
                        a &&
                            h.saveUploadId(
                                a,
                                t.UploadId,
                                n.options.UploadIdCacheLimit
                            ),
                            h.setUsing(t.UploadId),
                            o(null, !0),
                            s.call(
                                n,
                                {
                    ...
                    !e.Headers && (e.Headers = {}),
                    x.each(e.Headers, function(t, n) {
                        "content-length" === n.toLowerCase() &&
                            delete e.Headers[n];
                    }),
                    (function() {
                        for (
            ...
            function a(e, t) {
                var n = e.TaskId,
                    ...
                    b = function(e, t) {
                        ...
                        if (n > 1) {
                            if (Math.max(e[0].Size, e[1].Size) !== d)
                                return t(null, !1);
                        }
                ...
                S.on("error", function(e) {
                    ...
                    S.on("seek_local_avail_upload_id", function(t) {
                        ...
                        if (!o || !c)
                            return void S.emit("has_and_check_upload_id", t);

                        var p = function(e) {
                            if (e >= c.length)
                                return void S.emit(
                                    "has_and_check_upload_id",
                                    t
                                );
                            var o = c[e];
                            return x.isInArray(t, o)
                                ? h.using[o]
                                    ? void p(e + 1)
                                    : void r.call(
                                          l,
                        ...
                        o.call(
                            ...
                            function(t, a) {
                                if (l._isRunningTask(n)) {
                                    ...
                                    var o = x
                                        .filter(a.UploadList, function(e) {
                                            return (
                                                e.Key === s &&
                                                (!c ||
                                    ...
                                    if (o.length)
                                        S.emit("seek_local_avail_upload_id", o);
                                    else {
                                        var r,
                                            p = h.getFileId(
                                                e.FileStat,
                    ...
                    o = function() {
                        n.multipartList(a, function(e, n) {
                            ...
                            i.push.apply(i, n.Upload || []),
                                "true" === n.IsTruncated
                                    ? ((a.KeyMarker = n.NextKeyMarker),
                                      (a.UploadIdMarker = n.NextUploadIdMarker),
                                      o())
                                    : t(null, {
                                          UploadList: i
                                      });
            ...
            function u(e, t) {
                ...
                g.eachLimit(
                    ...
                    function(e) {
                        ...
                        for (
                            var n = [], i = [], a = 0, o = l.length;
                            a < o;
                            a++
                        ) {
                            var r = l[a];
                            r.task &&
                                (r.error ? i.push(r.task) : n.push(r.task));
                        }
